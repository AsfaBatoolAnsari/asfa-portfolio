        ...
        {!d ? (
          ...
          <>
            ...
            <div data-up="1" style={sx('margin-top:28px;aspect-ratio:16/10;border-radius:20px;overflow:hidden;border:1px solid rgba(255,255,255,0.1);background:linear-gradient(160deg,#2C2620,#1C1815)')}>
              <image-slot id={`dd-hero-${d.slug}`} shape="rect" placeholder={`Drop the ${d.title} main visual`}></image-slot>
            </div>
            ...
            <div className="glass" data-up="1" style={{ marginTop: 36, padding: 'clamp(26px,3.5vw,40px)' }}>
              ...
              <h2 style={{ ...sx("margin:12px 0 0;font-family:'Sora',sans-serif;font-weight:600;letter-spacing:-0.01em"), fontSize: 'clamp(20px,2.4vw,26px)' }}>Watch this design in action</h2>
              <p style={sx('margin:10px 0 0;max-width:54ch;font-size:14.5px;line-height:1.65;color:#A29889')}>Full walkthroughs, interactions and process clips live on my channels — tap to view the complete design.</p>
              <div style={sx('display:flex;flex-wrap:wrap;gap:12px;margin-top:22px')}>
                <Hoverable as="a" href="#" target="_blank" rel="noreferrer" base="display:inline-flex;align-items:center;gap:10px;border:1px solid rgba(255,255,255,0.14);background:rgba(255,255,255,0.05);border-radius:999px;padding:11px 20px;font-size:14px;font-weight:500;color:#F5F1EA" hoverCss="border-color:rgba(240,102,30,0.6);color:#F0661E">
