        ...
        <div id="ftGrid">
          <div style={sx('min-width:0')}>
            ...
            <div style={sx('display:grid;grid-template-columns:repeat(9,minmax(0,1fr));gap:8px;margin-top:22px;max-width:396px')}>
              <Hoverable as="a" href="#" target="_blank" rel="noreferrer" aria-label="LinkedIn" base={socialIconStyle} hoverCss={socialIconHover}>
              ...
              <Hoverable as="a" href="#" target="_blank" rel="noreferrer" aria-label="Instagram" base={socialIconStyle} hoverCss={socialIconHover}>
              ...
              <Hoverable as="a" href="#" target="_blank" rel="noreferrer" aria-label="Figma" base={socialIconStyle} hoverCss={socialIconHover}>
                <span style={sx("font-family:'Sora',sans-serif;font-weight:700;font-size:12px;line-height:1")}>Fig</span>
              </Hoverable>
              <Hoverable as="a" href="#" target="_blank" rel="noreferrer" aria-label="Behance" base={socialIconStyle} hoverCss={socialIconHover}>
                <span style={sx("font-family:'Sora',sans-serif;font-weight:700;font-size:12px;line-height:1")}>Bē</span>
              </Hoverable>
              <Hoverable as="a" href="#" target="_blank" rel="noreferrer" aria-label="TikTok" base={socialIconStyle} hoverCss={socialIconHover}>
              ...
              <Hoverable as="a" href="#" target="_blank" rel="noreferrer" aria-label="Facebook" base={socialIconStyle} hoverCss={socialIconHover}>
              ...
              <Hoverable as="a" href="https://wa.me/923153131393" target="_blank" rel="noreferrer" aria-label="WhatsApp" base={socialIconStyle} hoverCss={socialIconHover}>
              ...
              <Hoverable as="a" href="mailto:asfabatoolansari21@gmail.com" aria-label="Gmail" base={socialIconStyle} hoverCss={socialIconHover}>
              ...
              <Hoverable as="a" href="#" target="_blank" rel="noreferrer" aria-label="YouTube" base={socialIconStyle} hoverCss={socialIconHover}>
          ...
          <div style={sx('min-width:0')}>
            ...
            <div style={sx('display:flex;flex-direction:column;gap:16px;margin-top:20px')}>
              <Hoverable as="a" href="tel:03153131393" base="display:flex;align-items:center;gap:12px;color:#C9C0B4;font-size:14.5px" hoverCss="color:#F0661E">
                ...
                <span>031-53131393</span>
              </Hoverable>
              <Hoverable as="a" href="mailto:asfabatoolansari21@gmail.com" base="display:flex;align-items:center;gap:12px;color:#C9C0B4;font-size:14.5px" hoverCss="color:#F0661E">
                <span style={sx('display:inline-flex;align-items:center;justify-content:center;width:36px;height:36px;border-radius:10px;border:1px solid rgba(255,255,255,0.12);background:rgba(255,255,255,0.05);color:#F0661E;flex:0 0 auto')}>
